...
public class OrderProcessApp {
    private static Logger logger = Logger.getLogger(OrderProcessApp.class.getName());
...
//                .setMaster("local[*]"); // local parameter
        ...
        input.foreachRDD(rdd -> {
            ...
            rdd.foreach(record -> {
                ...
                System.out.println(rid + order_json);
                ...
                if (r.equals("-1")){
                    ...
                    System.out.println("ERROR checking order " + order.toString() + ", error code: " + r);
                }
                logger.info(r + " - " + order.toString());
                System.out.println(r + " - " + order.toString());
